  ...
  return (
    <div className="bg-ink text-ink-fg">
      <div className="mx-auto flex max-w-shell items-center gap-4 px-5 sm:px-[30px]">
        <span className="z-10 flex flex-none items-center gap-2 rounded bg-brand px-2.5 py-[5px] text-[11px] font-extrabold uppercase tracking-wide text-white">
          <span className="ticker-dot h-1.5 w-1.5 rounded-full bg-white" />
          {t("live")}
        </span>
        {/* clip riêng cho track — headline không tràn đè tag "Trực tiếp" */}
